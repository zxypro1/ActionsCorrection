package com.example.actionscorrection.ui.CircyleBar
...
class CircleProgressBar @JvmOverloads constructor(
    ...
    companion object {
        ...
        private val DEFAULT_RING_WIDTH = RxImageTool.dp2px(20f)
        private val DEFAULT_RING_COLOR = Color.parseColor("#24DB95")
        ...
        private val DEFAULT_DESC_TEXT = "目标 "
        private val DEFAULT_DESC_TEXT_SIZE = RxImageTool.sp2px(35f)
        private val DEFAULT_DESC_TEXT_COLOR = Color.parseColor("#1CE295")
        private val DEFAULT_PERCENT_TEXT_SIZE = RxImageTool.sp2px(20f)
        private val DEFAULT_PERCENT_TEXT_COLOR = Color.parseColor("#C4C4C4")
    }
    ...
    private fun measure(measureSpec: Int): Int {
        ...
        if (specMode == MeasureSpec.EXACTLY) {
            ...
            result = RxImageTool.dp2px(90f).toInt()
...
//            mArcPaint.strokeCap = Paint.Cap.BUTT
    ...
    private fun drawText(canvas: Canvas) {
        ...
        //绘制描述文本
        canvas.drawText("$progress", mRectF.centerX(), mHeight * 0.53f, mTextPaint)
        with(mTextPaint) {
